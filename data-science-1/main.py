...
def q1():
    ...
    q1_norm,q2_norm,q3_norm=dataframe.normal.quantile((.25,0.5,.75))
...
def q4():
    ...
    q4= (round(ecdf(Q_80),3),round(ecdf(Q_90),3),round(ecdf(Q_95),3))
    return q4
q4()
...
def q5():
    ...
    q5=(round(Q1-Norm_Q1,3),round(Q2-Norm_Q2,3),round(Q3-Norm_Q3,3))
    return q5 
q5()
